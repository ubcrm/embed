...
extern const motor_data_t *get_Yaw_Gimbal_Motor_Measure_Point(void);
//Return a pointer to pitch motor data
extern const motor_data_t *get_Pitch_Gimbal_Motor_Measure_Point(void);
//Return a pointer to trigger motor data
extern const motor_data_t *get_Trigger_Motor_Measure_Point(void);
//Return a pointer to trigger motor data
extern const motor_data_t *get_Revolver_Motor_Measure_Point(void);
//Return a pointer to chassis motors data
extern const motor_data_t *get_Chassis_Motor_Measure_Point(uint8_t i);
